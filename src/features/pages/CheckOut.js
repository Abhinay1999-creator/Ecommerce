...
import { selectCartItem, UpdateItemAsync, DeleteCartItemAsync } from '../cart/CartSlice'
import { Link, Navigate } from 'react-router-dom'
import { selectLoggednInUser, createUserAsync, updateUserAsync } from '../auth/authSlice'
import { selectOrderItem } from '../order/OrderSlice';
import { AddToOrderAsync } from '../order/OrderSlice'
...
export default function CheckOut() {
    ...
    const handleOrder = (e) => {
        ...
        if (selectedAddress && paymentMethod) {
            const order = { items, totalAmount, user, totalItems, paymentMethod, selectedAddress,status: 'pending' }
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                    <div className='lg:col-span-3'>
                        <form className='px-5 py-5 bg-white' noValidate
                                ...
                                <div className="border-b border-gray-900/10 pb-12">
                                            ...
                                            <li key={index} className="flex justify-between gap-x-6 py-5">
                                                <div className="flex min-w-0 gap-x-4">
                                                    <input
                                                        ...
                                                        type="radio"
                                                        value={index}
                                                        className="h-4 w-4 mt-5 border-gray-300 text-green-600 focus:ring-green-600"
                                                    />
                                    ...
                                    <div className="mt-10 space-y-10">
                                        ...
                                        <fieldset>
                                            ...
                                            <p className="mt-1 text-sm leading-6 text-gray-600">Choose your Payment Option</p>
                    ...
                    <div className='lg:col-span-2'>
                        <div className="mx-auto mt-12 bg-white max-w-7xl px-2 sm:px-2 lg:px-2">
                            <div className="mx-auto bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
                                <h1 className="text-4xl mt-5 my-5 text-center font-bold tracking-tight text-gray-900">Cart</h1>
